...
//khai bao mang hai chieu chua ma tran
#define MAX 20
int a[MAX][MAX];
int n;
char vertex[MAX];
...
int main()
{
	...
	do{
		...
		case 4:
			...
			break;
		case 5:
			cout <<"Tim cay khung toi tieu bang prim "<<endl;
			...
			break;
		case 6:
			cout <<"Tim cay khung toi tieu bang Kruskal "<<endl;
			taoE();
			Kruskla();
			cout << "Cay khung toi tieu " <<endl;
			output(true);
			break;
		case 7:
			cout <<"Tim cay khung toi tieu bang Kruskal cai tien "<<endl;
			taoE();
			sapxepE();
			Kruskla();
			cout << "Cay khung toi tieu " <<endl;
